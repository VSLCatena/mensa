                ...
                <v-form ref="mensaEditForm">
                    <v-tabs-items v-model="tab">
                        ...
                        <v-tab-item :key="1" class="pa-5">
                                    ...
                                    <template v-for="(item, index) in editor.menu">
                                        <div :key="item.draggableId">
                                            <v-list-item>
                                                ...
                                                <v-list-item-icon @click="editor.menu.splice(index, 1)"
                            ...
                            <v-btn class="pa-2 icon-button" outlined @click="onAddMenuItemClicked()">
                        ...
                        <v-tab-item :key="2" class="pa-5">
                                    ...
                                    <template v-for="(item, index) in editor.extraOptions">
                                        <div :key="item.draggableId">
                                            <v-list-item>
                                                ...
                                                <v-list-item-icon @click="editor.extraOptions.splice(index, 1)"
                                                                  class="clickable delete-button">
                                                    <v-icon>mdi-delete</v-icon>
                                                </v-list-item-icon>
                                            </v-list-item>
                            ...
                            <v-btn class="pa-2 icon-button" outlined @click="onAddExtraOptionClicked()">
                                <v-icon>mdi-plus-thick</v-icon>
                            </v-btn>
                        </v-tab-item>
